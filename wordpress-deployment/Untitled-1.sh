root@ubuntu-s-2vcpu-2gb-minikube:~# helm install my-mysql-operator mysql-operator/mysql-operator \
>    --namespace mysql-operator --create-namespace
NAME: my-mysql-operator
LAST DEPLOYED: Thu Aug  4 00:36:50 2022
...
root@ubuntu-s-2vcpu-2gb-minikube:~#
